...
ttestEvidence(1,  83, 83, Cauchy = F)
...
power.t.test(n = 83, delta = 0.3)
power.t.test(n = 46, delta = 0.3, type = "one.sample")
...
```{r lindley, fig.width=10, fig.height=6, echo=FALSE, message=FALSE, warning=FALSE, results='hide', fig.cap="Optimal alpha Level for within and between-sample $t$-tests for Cauchy and Unit Information Prior \textcolor{red}{[Interesting that it switches with respect to which results in a lower alpha level.]}"}
plot
```
